...
/**
 * This class is an implementation of {@link OrganizationalDataSet}.
 *
 * @author Kevin Haller
 */
public class SimpleOrganizationalDataSet implements OrganizationalDataSet {

    private static final Logger logger = LoggerFactory.getLogger(SimpleSpatialDataSet.class);

    public static final String[] KEYWORDS =
        new String[] {"organizational", "organization", "person"};
    public static final String TITLE =
        "Dataset concerning organizational information about the Vienna University of Technology.";
     ...
     *                           source.
     */
    public SimpleOrganizationalDataSet(TripleStoreManager tripleStoreManager) {
    ...
    private Model initSpatialDataSetDescription(Date issued) {
        ...
        spatialDataModel.add(NS, DCTERMS.ACCRUAL_PERIODICITY, SDMX_CODE.freq_W);
