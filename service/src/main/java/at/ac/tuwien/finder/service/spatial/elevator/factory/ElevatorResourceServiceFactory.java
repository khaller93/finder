...
import at.ac.tuwien.finder.dto.spatial.ElevatorDto;
 ...
 * of a specific elevator.
 *
 * @author Kevin Haller
 */
class ElevatorResourceServiceFactory extends InternalTreeNodeServiceFactory {

    private TripleStoreManager tripleStoreManager;

    ElevatorResourceServiceFactory(TripleStoreManager tripleStoreManager) {
    ...
    public IService getService(IResourceIdentifier parent, Scanner pathScanner,
        ...
        return new DescribeResourceService(tripleStoreManager, newParent.rawIRI()) {
            ...
            protected Dto wrapResult(Model model) throws ServiceException {
                return RDFMapper.create().readValue(model, ElevatorDto.class, newParent.iriValue());
            }
        };
    }
}
