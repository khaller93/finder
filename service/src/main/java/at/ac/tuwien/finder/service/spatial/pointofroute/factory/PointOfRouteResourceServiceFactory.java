...
import at.ac.tuwien.finder.dto.spatial.PointsOfRouteDto;
...
/**
 * This class is an implementation of {@link IServiceFactory} that
 * provides access to services for a specific point of route resource.
 *
 * @author Kevin Haller
 */
class PointOfRouteResourceServiceFactory extends InternalTreeNodeServiceFactory {
     ...
     */
    PointOfRouteResourceServiceFactory(TripleStoreManager tripleStoreManager) {
        ...
        return new DescribeResourceService(tripleStoreManager, newParent.rawIRI()) {
            ...
            protected Dto wrapResult(Model model) throws ServiceException {
                return RDFMapper.create()
                    .readValue(model, PointsOfRouteDto.class, newParent.iriValue());
            }
        };
    }
}
